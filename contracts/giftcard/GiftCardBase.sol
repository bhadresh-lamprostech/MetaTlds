...
import "./IGiftCardBase.sol";
import "../access/TldAccessable.sol";

contract GiftCardBase is
    ERC1155,
    IGiftCardBase,
    Pausable,
    TldAccessable
{
    ...
    constructor(ISANN _sann) ERC1155("") TldAccessable(_sann) {}
    ...
    function setURI(string calldata newURI) external onlyPlatformAdmin {
        _setURI(newURI);
    }
